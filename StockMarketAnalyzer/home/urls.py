...
from .views import IndexView,LogoutView,LoginView,PasswordChangeView,DashboardView,AboutUsView,FaviconView,RssView,SearchView,AddStockView
...
urlpatterns = [
    ...
    path("search",SearchView.as_view(),name="about"), # Search
    path("addStock/<int:id>/",AddStockView.as_view(),name="about"), # Search
