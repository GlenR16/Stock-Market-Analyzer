...
from .views import IndexView,LogoutView,LoginView,PasswordChangeView,DashboardView,AboutUsView,FaviconView,RssView,EditStockView
...
urlpatterns = [
    ...
    path("editStock/<int:id>/",EditStockView.as_view(),name="editStock"), # Search
